...
import { getDatabase, ref, set, push, child,get, onValue, query, orderByChild, equalTo } from "firebase/database";
...
export { app, analytics, database, ref, set, push, child, get, onValue, query, orderByChild, equalTo };